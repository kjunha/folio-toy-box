      ...
      <div class="row">
        <section class="6u 12u$(medium)">
          ...
          <p>
            ...
            projects with <a href="http://skel.io">Skel</a>. It features clear,
            concise HTML5 and CSS3 code (built on
        ...
        <section class="3u 6u(medium) 12u$(small)">
          ...
          <p>
            ...
            accumsan felis sed dolor interdum ut. Amet accumsan magna etiam orci
            faucibus interdum et lorem ipsum et nullam.
          </p>
        </section>
        <section class="3u$ 6u$(medium) 12u$(small)">
          <h3>Lorem Ipsum</h3>
        ...
        <div class="6u$ 12u$(medium)">
          ...
          <p>
            <span class="image left"
              ><img src="~/assets/images/pic02.jpg" alt=""/></span
